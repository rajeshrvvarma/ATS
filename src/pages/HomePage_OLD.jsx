...
import { Shield, Users, Target, Code, Sparkles, X, Briefcase, Award, MessageCircle, Server, BrainCircuit, Sword, CheckCircle, ArrowRight, Star, TrendingUp, Clock, DollarSign, BookOpen, Globe, Zap } from 'lucide-react';
...
const ProgramsShowcase = ({ onNavigate }) => {
    const programs = [
        ...
        },
        {
            ...
            description: 'Comprehensive cybersecurity training with personal mentorship',
            price: '₹5,999',
            ...
            <div className="container mx-auto px-6">
                ...
                >
                    ...
                    <p className="text-xl text-slate-300 max-w-3xl mx-auto">
                        From intensive bootcamps to elite mastery programs - find the perfect cybersecurity training for your career goals
                    </p>
                </motion.div>
