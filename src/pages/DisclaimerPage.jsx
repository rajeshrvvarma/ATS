...
const LegalPage = ({ onNavigate, title, children }) => (
    <div className="bg-slate-900 bg-fixed text-white min-h-screen">
        <div className="container mx-auto px-6 py-12 md:py-20">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-orange-400 text-center mb-4">{title}</h1>
...
export default function DisclaimerPage({ onNavigate }) {
    return (
        <LegalPage onNavigate={onNavigate} title="Disclaimer">
            ...
            <h3 className="text-xl font-bold text-orange-400 pt-4">Professional Disclaimer</h3><p>The website cannot and does not contain financial or career advice. The information is provided for educational and informational purposes only and is not a substitute for professional advice. Accordingly, before taking any actions based upon such information, we encourage you to consult with the appropriate professionals. We do not provide any kind of career or employment guarantee.</p>
            <h3 className="text-xl font-bold text-orange-400 pt-4">External Links Disclaimer</h3><p>The site may contain links to other websites or content belonging to or originating from third parties. Such external links are not investigated, monitored, or checked for accuracy by us. We do not warrant, endorse, guarantee, or assume responsibility for the accuracy or reliability of any information offered by third-party websites linked through the site.</p>
        </LegalPage>
    );
}
