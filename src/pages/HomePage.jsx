    ...
    const heroPanels = [
        {
            ...
            return (
                <>
                    ...
                    <div className="min-h-[35vh] flex items-center justify-center bg-slate-900 bg-fixed py-4 md:py-8 relative">
                            ...
                            <div className="text-center mb-2 relative">
                                ...
                                <div className="flex justify-center gap-16 mt-0">
                                    <svg width="160" height="110" viewBox="0 0 160 110" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M80 20 Q80 90 40 100" stroke={activeHero === 0 ? '#22d3ee' : '#facc15'} strokeWidth="10" fill="none" strokeLinecap="round" />
                                        <polygon points="28,100 52,110 40,80" fill={activeHero === 0 ? '#22d3ee' : '#facc15'} />
                                    </svg>
                                    <svg width="160" height="110" viewBox="0 0 160 110" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M80 20 Q80 90 120 100" stroke={activeHero === 0 ? '#22d3ee' : '#facc15'} strokeWidth="10" fill="none" strokeLinecap="round" />
                                        <polygon points="132,100 108,110 120,80" fill={activeHero === 0 ? '#22d3ee' : '#facc15'} />
                                    </svg>
                                </div>
