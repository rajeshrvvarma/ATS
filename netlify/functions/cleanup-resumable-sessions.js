...
// This function should be scheduled (Netlify cron) or invoked manually.
// It looks for upload_sessions collection documents older than expiry and attempts to cancel/cleanup resumable sessions in GCS.
    ...
    for (const doc of snapshot.docs) {
      ...
      try {
        if (data.bucket && data.path) {
          ...
          // We can't directly 'cancel' a resumable session via the client library; deleting the object will prevent partial objects from lingering.
